...
namespace IcosaClientEditor
{
    ...
    public class AssetBrowserWindow : EditorWindow
    {
        ...
        private static readonly CategoryInfo[] CATEGORIES =
        {
            ...
            new CategoryInfo("food", "Food and Drink", IcosaCategory.FOOD),
            new CategoryInfo("nature", "Nature", IcosaCategory.NATURE),
            new CategoryInfo("objects", "Objects", IcosaCategory.OBJECTS),
            new CategoryInfo("people", "People and Characters", IcosaCategory.PEOPLE),
            new CategoryInfo("places", "Places and Scenes", IcosaCategory.PLACES),
            new CategoryInfo("tech", "Technology", IcosaCategory.TECH),
            new CategoryInfo("transport", "Transport", IcosaCategory.TRANSPORT),
        };
        ...
        /// </summary>
        private IcosaFormatFilter? assetTypeFilter = null;
        ...
        /// Shows the browser window.
        /// </summary>
        [MenuItem("Window/Icosa: Browse Assets...")]
        public static void BrowseIcosaAssets2()
        {
            BrowseIcosaAssets();
        }
        ...
        public void OnGUI()
        {
            ...
            guiHelper.BeginArea(new Rect(PADDING, PADDING, position.width - 2 * PADDING,
        ...
        private void DrawTitleBar(bool withSignInUi)
        {
            ...
            if (IcosaApi.IsAuthenticated)
            {
                ...
                guiHelper.BeginHorizontal();
                GUILayout.FlexibleSpace();
                Texture2D userTex = IcosaApi.UserIcon != null && IcosaApi.UserIcon.texture != null
                    ? IcosaApi.UserIcon.texture
                    : loadingTex;
                if (GUILayout.Button(new GUIContent(userTex, /* tooltip */ IcosaApi.UserName),
        ...
        private void DrawBrowseUi()
        {
            ...
            if (showAssetTypeFilter)
            {
                ...
                bool blocksToggle = GUILayout.Toggle(assetTypeFilter == IcosaFormatFilter.BLOCKS, "Blocks", "Button");
                bool tiltBrushToggle =
                    GUILayout.Toggle(assetTypeFilter == IcosaFormatFilter.TILT, "Open Brush", "Button");
        ...
        private void DrawResultsGrid()
        {
            ...
            IcosaListAssetsResult result = manager.CurrentResult.Value;
            if (!result.status.ok)
            {
                GUILayout.Space(30);
        ...
        private IcosaRequest BuildRequest()
        {
            ...
            {
                IcosaListUserAssetsRequest listUserAssetsRequest = IcosaListUserAssetsRequest.MyNewest();
            ...
            {
                listAssetsRequest = IcosaListAssetsRequest.Featured();
            }
            else
            {
                listAssetsRequest = new IcosaListAssetsRequest();
                listAssetsRequest.category = info.IcosaCategory;
            }
        ...
        private void StartRequest()
        {
            if (mode == UiMode.BROWSE)
            {
                ...
                if (!queryRequiresAuth || IcosaApi.IsAuthenticated)
                {
        ...
        /// </summary>
        private void PrepareDetailsUi(IcosaAsset newSelectedAsset)
        {
        ...
        private void DrawDetailsUi()
        {
            ...
            if (GUILayout.Button("Replace existing..."))
            {
                ...
                EditorGUIUtility.ShowObjectPicker<PtAsset>(current, /* allowSceneObjects */ false, PtAsset.FilterString,
                    0);
            }
            ...
            {
                GUILayout.Label(IcosaInternalUtils.ATTRIBUTION_NOTICE, EditorStyles.wordWrappedLabel);
            }
            else
            {
        ...
        /// </summary>
        private bool ValidateImportOptions(IcosaImportOptions options, out string errorString)
        {
            switch (options.rescalingMode)
            {
                case IcosaImportOptions.RescalingMode.CONVERT:
                    ...
                    break;
                case IcosaImportOptions.RescalingMode.FIT:
        ...
        private string GetAssetFormatDescription(IcosaAsset asset)
        {
            List<string> formatTypes = new List<string>();
            if (asset.formats != null)
            {
                foreach (IcosaFormat format in asset.formats)
                {
        ...
        private struct CategoryInfo
        {
            public string key;
            public string title;
            public IcosaCategory IcosaCategory;

            public CategoryInfo(string key, string title, IcosaCategory icosaCategory = IcosaCategory.UNSPECIFIED)
            {
                this.key = key;
                this.title = title;
                this.IcosaCategory = icosaCategory;
            }
        }
    }
}
